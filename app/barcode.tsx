...
export default function BarcodeScanner() {
    ...
    const handleBarcodeScanned = ({ type, data }: BarcodeScanningResult) => {
        ...
        fetch(`${BACKEND_API_URL}/scan`, {
            ...
            .then((res) => res.json())
            .then((json) => console.log('Prefetch scan result', json))
    ...
    return (
        <SafeAreaView className="flex-1 bg-black">
            ...
            {scanned && (
                <Pressable className="absolute bottom-10 self-center bg-primary py-3 px-6 rounded-lg" onPress={() => setScanned(false)}>
